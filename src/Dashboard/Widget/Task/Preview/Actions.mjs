...
export default function Fl32_Leana_Dashboard_Widget_Task_Preview_Actions(spec) {
    ...
    const popupYesNo = spec.Fl32_Leana_Dashboard_Widget_Task_Preview_Actions_Remove$$;  // new instance
