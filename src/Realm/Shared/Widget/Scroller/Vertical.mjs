...
<div class="teq_ui_scroller_v" >
    ...
    <div class="teq_ui_scroller_v_display"></div>
    <div class="teq_ui_scroller_v_values">
 ...
 * @constructor
 */
export default function Fl32_Leana_Realm_Shared_Widget_Scroller_Vertical(spec) {
    const OnTouch = spec['Fl32_Leana_Realm_Shared_On_Touch#'];    // class
    ...
    return {
        ...
        mounted() {
            ...
            Object.defineProperty(onCancel, 'name', {
                writable: true,
                value: 'Fl32_Leana_Realm_Shared_Widget_Scroller_Vertical/mounted/onCancel'
            });
            Object.defineProperty(onDown, 'name', {
                writable: true,
                value: 'Fl32_Leana_Realm_Shared_Widget_Scroller_Vertical/mounted/onDown'
            });
            Object.defineProperty(onEnd, 'name', {
                writable: true,
                value: 'Fl32_Leana_Realm_Shared_Widget_Scroller_Vertical/mounted/onEnd'
            });
            Object.defineProperty(onMove, 'name', {
                writable: true,
                value: 'Fl32_Leana_Realm_Shared_Widget_Scroller_Vertical/mounted/onMove'
            });
            Object.defineProperty(onStart, 'name', {
                writable: true,
                value: 'Fl32_Leana_Realm_Shared_Widget_Scroller_Vertical/mounted/onStart'
            });
            Object.defineProperty(onUp, 'name', {
                writable: true,
                value: 'Fl32_Leana_Realm_Shared_Widget_Scroller_Vertical/mounted/onUp'
            });

            /** @type {Fl32_Leana_Realm_Shared_On_Touch} */
